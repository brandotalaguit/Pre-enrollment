...
class MY_Model extends CI_Model
{
	...
	public function delete_by($where, $single = FALSE)
	{
		...
		{
			$this->session->set_flashdata('error', "Sorry this application could not perform a BATCH PERMANENT DELETION.<br/>If still want to continue you have to delete it individually.");
			$this->db->flush_cache();
			return FALSE;
		}
	}
