    ...
    <div class="row">
    	<div class="span6">
      	...
      	<div class="span6">
            ...
            ?>
      		  <h2 style="font-family:arial;color:#000;border:3px solid #000;padding:2px 3px">SCHEDULE OF PAYMENT: 
              <?php
...
<!--    
 ...
 <ul>
     <li>Base on kind of Scholarshi</li>
 </ul> -->
  ...
  <ol>
    <li>
      <p>
        Together with your printed advising slip and payment, proceed to the nearest <strong>LANDBANK</strong> branch near you.
      </p>
    </li>
    <li>
      <p>
        Get two copies of <strong>LANDBANK</strong> deposit slip and fill up the seperated details corresponding to the Account numbers 
        (Misc. or Token Fee) and amount to be paid as shown in your advising slip.
      </p>
        ...
        <div class="row-fluid">
          ...
          <table class="table table-bordered table-condensed">
            <thead>
              <tr>
                <th>Deposit Slip <?php echo ++$ctr; ?></th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td>Account #: <strong>1-2345678-9</strong> (for Miscellanous Fee)</td>
              </tr>
              <tr>
                <td>Account Name: <strong>UNIVERSITY OF MAKATI</strong></td>
              </tr>
              <tr>
                <td>Deposit Amount: Php <strong><?php echo number_format( $SubTotal, 2, '.', ','); ?></strong> </td>
              </tr>
            </tbody>
          </table>
          ...
          <table class="table table-bordered table-condensed">
            ...
            <tbody>
              <tr>
                <td>Account #: <strong>1-2345678-9</strong> (for Token Fee)</td>
              </tr>
              <tr>
                <td>Account Name: <strong>UNIVERSITY OF MAKATI</strong></td>
              </tr>
              <tr>
                <td>Deposit Amount: Php <strong><?php echo number_format( $TokenFee,2 ); ?></strong> </td>
              </tr>
            </tbody>
          </table>
    ...
    <li>
      <p>
        Proceed to the bank teller and present your advising slip, 2 deposit slips and amount to be paid.* 
      </p>
    </li>
    <li>
      <p>
        Wait for the <strong>Transaction Slip</strong> after the transaction is done. 
        The slip will be used for proof of payment during the continuation of your enrollment at the <strong>Registrar's Office.</strong>
      </p>
    </li>
  </ol>
