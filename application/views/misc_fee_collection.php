<table class="table table-bordered table-condensed" style="white-space: nowrap;">
		...
		<tbody>
			...
			<tr>								
				...
				<td>
					<?php 
						$a1 = $this->db->select('tblpaymentmisc.amount as amount, ',FALSE)
								...
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
								->where('tblpaymentmisc.ornum',$row['ornum'])
				...
				<td>
					<?php 
						$a2 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a3 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a4 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a5 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a6 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a7 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a8 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a10 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a11 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a12 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a13 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a14 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a9 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a15 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a16 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a17 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a18 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a19 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a20 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a21 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a22 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')							
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a23 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a24 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
				...
				<td>
					<?php 
						$a25 = $this->db->select('tblpaymentmisc.amount as amount')
								->join('tblfees','tblassessmentinfo.feeid = tblfees.feeid','left')
								->join('tblassessmenttrans','tblassessmentinfo.assid = tblassessmenttrans.assid','left')
								->join('tblpaymentmisc','tblpaymentmisc.feeid = tblfees.feeid', 'left')
								->where('tblassessmenttrans.StudNo',$row['newstudid'])
